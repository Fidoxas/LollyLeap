...
namespace Lean.Transition
{
	...
	public abstract class LeanState
	{
		...
		/// <summary>If this is  then the current transition will no longer update, but will otherwise act as normal and not be removed. This is so any transition chain can still work as expected.</summary>
		[System.NonSerialized]
		public bool Ignore;
