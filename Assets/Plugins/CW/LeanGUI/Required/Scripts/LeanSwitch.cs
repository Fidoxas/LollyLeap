...
namespace Lean.Gui
{
	...
	public class LeanSwitch : MonoBehaviour
	{
		...
		/// <summary>This stores all active and  LeanSwitch instances.</summary>
		...
		/// <summary>This allows you to switch all active and  states with the specified name to the specified state.</summary>
