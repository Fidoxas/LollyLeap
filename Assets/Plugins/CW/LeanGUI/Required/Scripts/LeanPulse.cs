...
namespace Lean.Gui
{
	...
	public class LeanPulse : MonoBehaviour
	{
		...
		/// <summary>This stores all active and  LeanPulse instances, so you can manually pulse them by name from anywhere.</summary>
		...
		/// <summary>This method calls TryPulse on all active and  LeanPulse instances with the specified GameObject name.</summary>
		...
		/// <summary>This method calls Pulse on all active and  LeanPulse instances with the specified GameObject name.</summary>
