...
namespace Lean.Gui
{
	...
	{
		/// <summary>This stores all active and  LeanToggle instances.</summary>
		...
		/// <summary>This will return true if all the active and  toggle instances with the specified GameObject name are turned on.</summary>
		...
		/// <summary>This will return true if all the active and  toggle instances with the specified GameObject name are turned off.</summary>
		...
		/// <summary>This allows you to set the <b>On</b> state of all the active and  toggle instances with the specified GameObject name.</summary>
		...
		/// <summary>This allows you to toggle the state (i.e. if it's turned on, then this will turn it off) of all active and  toggle instances with the specified GameObject name.</summary>
		...
		/// <summary>This allows you to turn on every active and  toggle instance with the specified GameObject name.</summary>
		...
		/// <summary>This allows you to turn off each active and  LeanToggle instance with the specified GameObject name.</summary>
